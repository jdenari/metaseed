<template>
    <div class="p-3 metaseed-values-div my-5">
        ...
        <div class="col-md-5 col-9 bg-text mx-auto mt-5 p-3 rounded">
            ...
            <div class="h4 m-2 my-4">Acreditamos que o empreendedorismo tem o poder de mudar a sociadade. Por isso somos uma empresa focada em levar conhecimento para micro e pequenos empresários para que possam evoluir o nível de suas empresas e mudarem a sociedade.</div>
        </div>
